...
address        = "https://gitlab.com/api/v4/projects/GITLAB_PROJECT_ID/terraform/state/alert-triage-dev"
lock_address   = "https://gitlab.com/api/v4/projects/GITLAB_PROJECT_ID/terraform/state/alert-triage-dev/lock"
unlock_address = "https://gitlab.com/api/v4/projects/GITLAB_PROJECT_ID/terraform/state/alert-triage-dev/lock"
lock_method    = "POST"
